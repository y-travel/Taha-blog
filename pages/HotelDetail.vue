          ...
          <div class="about">
            <div class="row">
              <div class="col-sm-3" style="border: 2px !important">
                <span class="large"> {{ htl.address }} <br /> </span>
              </div>
            </div>
            <br />
          </div>
        ...
        <div class="col-sm-12">
          <div class="about">
            ...
            <p class="desc">
              ...
              ۲- کاربران متعهد می‌شوند که اطلاعات خود را هنگام ثبت‌نام و رزرو به
              صورت صحیح در وب‌سایت وارد کنند. در صورت ورود اطلاعات ناقص يا
              نادرست، مسئولیت عواقب بعدی این عمل بر عهده‌ی کاربران خواهد بود.<br />
            </p>
          </div>
        </div>
      </div>
