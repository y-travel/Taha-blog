<template>
  <div :class="{ ltrdir: $i18n.locale === 'en' }">
    <div dir="center">
      <b-card class="col-sm-12" align="right" style="border: 0 !important; min-height: 120px">
        <b-card-text>
          ...
          <div class="col-sm-3" v-for="pkg in pkgs" :key="pkg.id">
            <div class="col-sm-8 contact-info">
              ...
              <p>
                &nbsp;&nbsp;&nbsp;{{
                    pkg.basePrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')
                }}ریال
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              </p>
            ...
            <div class="col-sm-4">
              <img src="/assets/images/home/karbala-logo.png" style="padding: 5px;height: 50px;" class="img-responsive"
                alt="img" />
            </div>
          </div>
        </b-card-text>
