                ...
                <b-card-text>
                    ...
                    <div class="col-sm-3" v-for="hotel in hotels" :key='hotel.id'>
                        <div class="col-sm-8 contact-info">
                            ...
                            <nuxt-link class="btn btn-default" :to="`/HotelDetail?id=${hotel.id}`">
    ...
    setup() {
        ...
        const init = async () => {
            ...
            try {
                ...
                hotels.value = (await getRequest('/api/hotels?pagination[page]=1&pagination[pageSize]=4'))?.data;
        ...
        return {
            ...
            async changeP(PageNo: string) {
                ...
                hotels.value = (await getRequest('/api/hotels?pagination[page]='
